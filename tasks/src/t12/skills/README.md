...
1. Open [task/AnthropicApp.java](task/AnthropicApp.java) and implement all `TODO` items
2. Run `task/AnthropicApp.java` and test it using the **Style Guide** and **Calculator** sample requests below.
...
1. Open [task/OpenAiApp.java](task/OpenAiApp.java) and implement all `TODO` items
2. Run `task/OpenAiApp.java` and test it using the **Style Guide** and **Calculator** sample requests below.
...
1. Implement all TODO in [task/custom/_skills/unit-converter/SKILL.md](task/custom/_skills/unit-converter/SKILL.md)
2. Open [task/custom/tools/ReadSkill.java](task/custom/tools/ReadSkill.java) and implement all `TODO`
3. Open [task/custom/tools/PythonCodeInterpreter.java](task/custom/tools/PythonCodeInterpreter.java) and implement all `TODO`
4. Open [task/custom/Agent.java](task/custom/Agent.java) and implement all `TODO`
5. Open [task/custom/App.java](task/custom/App.java) and implement all `TODO`
6. Make sure the MCP server is running, then run [task/custom/App.java](task/custom/App.java) and test it using the **Convertor** sample
   requests below.
