...
public class OpenAiResponsesTask {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        TuningApp.run(
                ...
                //  Try: "text", new ObjectMapper().readTree(
                //        """
                //        {"format": {"type": "json_schema", "name": "languages", "strict": true, "schema": {"type": "object", "properties": {"languages": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "year": {"type": "integer"}}, "required": ["name", "year"], "additionalProperties": false}}}, "required": ["languages"], "additionalProperties": false}}}
                //        """)
