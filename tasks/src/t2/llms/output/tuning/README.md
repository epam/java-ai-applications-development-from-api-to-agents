...
Open [OpenAiChatCompletionsTask](OpenAiChatCompletionsTask.java) and follow TODO 1–10:
- `n`, `temperature`, `top_p`, `max_completion_tokens`, `stop`
...
Open [OpenAiResponsesTask](OpenAiResponsesTask.java) and follow TODO 1–8.
...
Open [AnthropicTask](AnthropicTask.java) and follow TODO 1–6:
...
### 4. Gemini (Optional)
Open [GeminiTask.py](GeminiTask.java) and follow TODO 1–6:
