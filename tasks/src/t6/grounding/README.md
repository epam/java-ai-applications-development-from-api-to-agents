...
A comprehensive Java implementation demonstrating different approaches to grounding AI systems with external data sources.
...
- How to implement vector-based similarity search using Spring AI `SimpleVectorStore`
...
### 1. No Grounding — [t1/NoGroundingApp.java](t1/NoGroundingApp.java)
Direct LLM processing without external knowledge integration.

Open [t1/NoGroundingApp.java](t1/NoGroundingApp.java) and explore how it works:
...
#### API-based — [t2/InputApiBasedGroundingApp.java](t2/InputApiBasedGroundingApp.java)
Open [t2/InputApiBasedGroundingApp.java](t2/InputApiBasedGroundingApp.java) and explore how it works:
...
#### Vector-based — [t2/InputVectorBasedGroundingApp.java](t2/InputVectorBasedGroundingApp.java)
Open [t2/InputVectorBasedGroundingApp.java](t2/InputVectorBasedGroundingApp.java) and explore how it works:
- Creates vector embeddings for all users using `text-embedding-3-small`
- Performs similarity search using Spring AI `SimpleVectorStore`
...
### 3. Input-Output Grounding — [t3/InOutGroundingApp.java](t3/InOutGroundingApp.java)
Combines vector search with structured output and real-time data retrieval.

Open [t3/InOutGroundingApp.java](t3/InOutGroundingApp.java) and explore how it works:
- Uses Spring AI `SimpleVectorStore` for semantic similarity filtering
- Structures LLM output with JSON response format (`ResponseFormatJsonObject`)
